...
#ifndef VXWORKS
int evopen_(char *filename,char *flags,long *handle,int fnlen,int flen)
{
  char *fn, *fl;
  int status;
...
int evOpen(char *filename,char *flags,long *handle)
{
  EVFILE *a;
  char *cp;
  int header[EV_HDSIZ];
...
#ifndef VXWORKS
int evread_(long *handle,int *buffer,int *buflen)
{
  return(evRead(*handle,buffer,*buflen));
}
#endif

int evRead(long handle,int *buffer,int buflen)
{
  EVFILE *a;
...
#ifndef VXWORKS
int evwrite_(long *handle,int *buffer)
{
  return(evWrite(*handle,buffer));
}
#endif

int evWrite(long handle,int *buffer)
{
  EVFILE *a;
...
#ifndef VXWORKS
int evioctl_(long *handle,char *request,void *argp,int reqlen)
{
  char *req;
  int status;
...
int evIoctl(long handle,char *request,void *argp)
{
  EVFILE *a;
  a = (EVFILE *)handle;
  if (a->magic != EV_MAGIC) return(S_EVFILE_BADHANDLE);
...
#ifndef VXWORKS
int evclose_(long *handle)
{
  return(evClose(*handle));
}
#endif

int evClose(long handle)
{
  EVFILE *a;
 ...
 *****************************************************************/
int evOpenSearch(long handle, long *b_handle)
{
  EVFILE *a;
  EVBSEARCH *b;
 ...
 *******************************************************************/
int evSearch(long handle, long b_handle, int evn, int *buffer, int buflen, int *size)
{
  EVFILE    *a;
  EVBSEARCH *b;
  int       start,end, mid;
 ...
 **********************************************************************/
int evCloseSearch(long b_handle)
{
  EVBSEARCH *b;
