...
signal G     : std_logic_vector(1 downto 0);
		...
		signal PF_temp_lv1_04: std_logic_vector(  77 downto 0);
		...
		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8		signal PF_temp_lv8: std_logic_vector(  11 downto 0);
		...
		signal NF_temp_lv1_04: std_logic_vector(  69 downto 0);
		...
		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8		signal NF_temp_lv8: std_logic_vector(  11 downto 0);
BEGIN
...
begin
 if c1'event and c1='1' then
		...
		if(A(11)='1' AND B( 7)='1' AND D( 7)='1' AND E( 7)='1' )then
		  PF_temp_lv1_04(  77)<='1';
		  else
		  PF_temp_lv1_04(  77)<='0';
		  end if;
		...
		if(A(11)='1' AND B( 8)='1' AND D( 8)='1' AND E( 8)='1' )then
		  NF_temp_lv1_04(  69)<='1';
		  else
		  NF_temp_lv1_04(  69)<='0';
		  end if;
...
begin
 if c1'event and c1='1' then
		...
		if(PF_temp_lv1_04(  76)='1' OR PF_temp_lv1_04(  77)='1' )then
		  PF_temp_lv2_04(  19)<='1';
		  else
		  PF_temp_lv2_04(  19)<='0';
		  end if;
		...
		if(NF_temp_lv1_04(  68)='1' OR NF_temp_lv1_04(  69)='1' )then
		  NF_temp_lv2_04(  17)<='1';
		  else
		  NF_temp_lv2_04(  17)<='0';
		  end if;
